...
@section('content')
    <main class="mx-md-3" >
        @if(session('success'))
            <span class="alert alert-success my-md-2" role="alert">
                <strong>{{ session('success') }}   Enjoy your shopping!</strong></span>

        @else
            <span class="alert alert-danger my-md-2" role="alert">
         <strong>Upss! You have an error to payment</strong>
         </span>
        @endif
        <section >
